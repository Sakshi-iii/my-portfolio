    ...
    <section id="about" className="py-24 bg-secondary-bg">
      <div className="container mx-auto px-6 lg:px-20">
        ...
        >
          ...
          I'm Sakshi, a Computer Science student who enjoys exploring how technology works beneath the surface. From experimenting with cybersecurity tools to building backend systems and working on AI-based projects, I like understanding problems deeply and turning ideas into practical solutions. Beyond coding, I enjoy learning new technologies, collaborating on technical projects, and constantly pushing myself to improvement.
          </p>
        </motion.div>
